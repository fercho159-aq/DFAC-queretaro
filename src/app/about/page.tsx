...
const milestones = [
  ...
  { year: "2018", event: "Nos establecemos en Querétaro para servir a toda la región del Bajío." },
  { year: "2022", event: "Alcanzamos 1,000 proyectos exitosos en Querétaro y sus alrededores." },
];
...
const differentiators = [
    {
      ...
      description: "Nuestro sistema logístico garantiza la entrega de tu material en menos de 24 horas en Querétaro y el Bajío."
    },
    {
    ...
    <>
      ...
      <section className="relative bg-card py-20 md:py-32">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-black font-headline text-white tracking-tight">
            Somos el <b className="text-primary">cimiento</b> de los <span className="inline-block px-4 py-2 mt-2 bg-[#FFC107]/75 text-primary rounded-lg">grandes proyectos del Bajío</span>.
          </h1>
          <p className="mt-6 max-w-3xl mx-auto text-lg md:text-xl text-slate-200">
            Más que un proveedor, somos tu <b className="text-white">socio estratégico</b> en cada obra, comprometidos con la <b className="text-white">seguridad</b>, la <b className="text-white">calidad</b> y la <b className="text-white">eficiencia</b> en Querétaro y toda la región.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
            ...
            En DFAC, nos dedicamos a proveer <b className="text-foreground">soluciones de cimbra y andamiaje</b> que garantizan seguridad, eficiencia y rapidez en cada obra de Querétaro y el Bajío. Nacimos para resolver un problema clave en la construcción regional: la necesidad de contar con material de alta resistencia de forma inmediata. Por eso, nuestra promesa es simple y poderosa: <span className="font-semibold text-primary">calidad que soporta tus ideas, entregada en menos de 24 horas.</span>
            </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-8 text-center">
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-muted-foreground mt-2">Facilitar el <b className="text-foreground">éxito</b> de cada proyecto en el Bajío con accesorios de alta calidad y un servicio de entrega inigualable.</p>
                </div>
                <div className="flex flex-col items-center">
                    <Eye className="w-12 h-12 text-primary mb-4" />
                    <h3 className="text-2xl font-bold">Visión</h3>
                    <p className="text-muted-foreground mt-2">Ser el proveedor <b className="text-foreground">líder y de mayor confianza</b> en soluciones para cimbra y andamiaje en Querétaro y toda la región.</p>
                </div>
                <div className="flex flex-col items-center">
        ...
        <section className="py-20 bg-background">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold font-headline">Nuestra <span className="text-primary">Trayectoria en el Bajío</span></h2>
                    <p className="mt-4 text-lg text-muted-foreground">Más de una década construyendo <b className="text-foreground">confianza</b> en la región.</p>
                </div>
      ...
      <section className="py-12 bg-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h3 className="text-center text-sm font-bold text-muted-foreground tracking-widest uppercase">EMPRESAS QUE CONSTRUYEN CON NOSOTROS EN EL BAJÍO</h3>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-headline">¿Listo para llevar tu proyecto en Querétaro al <br/><span className="italic">siguiente nivel?</span></h2>
