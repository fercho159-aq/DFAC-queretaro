    ...
    questions: [
      {
        ...
        answer: "Ofrecemos una amplia gama de productos, incluyendo puntales metálicos, sistemas de anclaje, moños, cuñas, andamios estándar, plataformas, vigas y todo tipo de accesorios para garantizar la seguridad y eficiencia de tu obra en Querétaro y el Bajío."
      },
      {
      ...
      },
      {
        ...
        answer: "¡Por supuesto! Nuestro equipo de expertos está disponible para brindarte asesoría técnica personalizada y ayudarte a seleccionar la solución más adecuada para las necesidades específicas de tu proyecto en la región."
      }
    ]
  },
  {
    category: "Envíos y Entregas en Querétaro y el Bajío",
    questions: [
      {
        question: "¿Cuál es el tiempo de entrega?",
        answer: "Nuestra promesa es simple: garantizamos la entrega de tu material en menos de 24 horas en nuestra zona de cobertura principal en Querétaro y el Bajío. Para otras zonas, el tiempo puede variar ligeramente."
      },
      {
      ...
      <div className="bg-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
            Aquí encontrarás respuesta a las dudas más comunes sobre nuestros <b className="text-foreground">productos, envíos y servicios</b> en la región del Bajío. Queremos <b className="text-foreground">facilitar tu proceso</b> de compra.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mt-16 text-center bg-primary text-primary-foreground p-10 rounded-lg">
            ...
            <p className="mt-2 text-lg text-primary-foreground/80">
                Nuestro equipo de <b className="text-white">expertos</b> en Querétaro está listo para ayudarte.
            </p>
